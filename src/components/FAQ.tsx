...
const FAQ = () => {
  const faqs = [
    ...
    {
      id: "item-7",
      question: "Отличается ли работа психолога от психотерапевта?",
      answer: "Я работаю как психолог-консультант, что означает, что помогаю людям справляться с жизненными трудностями, развивать навыки самопознания и улучшать качество жизни. Мой подход включает элементы различных психотерапевтических направлений, адаптированных под конкретные потребности каждого клиента."
    },
    {
      id: "item-8",
      question: "Что делать, если мне становится хуже в процессе терапии?",
      answer: "Иногда в процессе работы могут обостряться переживания — это нормальная часть процесса исцеления. Важно сразу сообщить мне об этом. Мы скорректируем подход, при необходимости изменим интенсивность работы или используем дополнительные техники поддержки. Ваше благополучие — главный приоритет, и мы всегда найдем способ сделать процесс более комфортным."
    }
  ];
